...
public class View implements IView{
    private static final int DASHES = 15;
    ...
    public View(InputStream inputStream, IPresenter presenter, boolean isScriptMode) {
    ...
    public View(InputStream inputStream, boolean isScriptMode) {
        this(inputStream, null, isScriptMode);
    }

    public View(IPresenter presenter, boolean isScriptMode) {
        this(System.in, presenter, isScriptMode);
    }

    public View(boolean isScriptMode) {
    ...
    public ICommand readCommand() throws CommandNotFoundException, BadCommandArgException,
            BadCommandArgsNumberException, NullCommandException {
